...
st.write("`1.` Copy & Paste the sample inputs from the dropdowns under each text box")
st.write("`2.` Run the script by pressing the button on the bottom of the page ")
